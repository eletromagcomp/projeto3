...
#%% RODA O CAMPO DO KIRBY

pi = math.pi
tempo = np.linspace(0.0,4*pi/omega(),60) #cria a sequencia temporal onde sao calculados os campos varrendo 3 periodos
